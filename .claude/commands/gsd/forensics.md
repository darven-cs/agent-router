...
<execution_context>
@/home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
