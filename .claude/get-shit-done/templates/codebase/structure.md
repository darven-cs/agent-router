...
- Usage: Reference from command with `@/home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/darven/桌面/dev_app/agent-router/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/darven/桌面/dev_app/agent-router/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
