...
- **Global scope**: `/home/darven/桌面/dev_app/agent-router/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/darven/桌面/dev_app/agent-router/.claude/notes/`)
...
2. Glob `/home/darven/桌面/dev_app/agent-router/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/darven/桌面/dev_app/agent-router/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/darven/桌面/dev_app/agent-router/.claude/notes/` — works in any directory
