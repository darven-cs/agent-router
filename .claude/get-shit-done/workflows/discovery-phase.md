...
See /home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/discovery.md
...
Use /home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/discovery.md.
