...
Reference full template: `/home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/darven/桌面/dev_app/agent-router/.claude/get-shit-done/templates/state.md`.
